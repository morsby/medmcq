  ...
  (T.isFunction =
      ...
      return (
        v.each(function() {
          var a,
            ...
            s,
            r = T.isPlainObject(p)
              ? T.extend(!0, {}, T.fn.dimmer.settings, p)
              : T.extend({}, T.fn.dimmer.settings),
            n = r.selector,
            e = r.namespace,
            t = r.className,
            d = r.error,
          ...
          (s = {
            ...
            instantiate: function() {
              s.verbose('Storing instance of module', s), (g = s), u.data(m, g);
            },
            destroy: function() {
            ...
            bind: {
              events: function() {
                'hover' == r.on
                  ? i.on('mouseenter' + o, s.show).on('mouseleave' + o, s.hide)
                  : 'click' == r.on && i.on(l + o, s.toggle),
                  s.is.page() && (s.debug('Setting as a page dimmer', i), s.set.pageDimmer()),
                  s.is.closable() &&
                    (s.verbose('Adding dimmer close event', a),
                    i.on(l + o, n.dimmer, s.event.click));
              }
            },
            unbind: {
              events: function() {
                u.removeData(m), i.off(o);
              }
            },
            event: {
              click: function(e) {
                s.verbose('Determining if event occured on dimmer', e),
                  (0 === a.find(e.target).length || T(e.target).is(n.content)) &&
            ...
            show: function(e) {
              (e = T.isFunction(e) ? e : function() {}),
                ...
                (s.is.dimmed() && !s.is.animating()) || !s.is.enabled()
                  ...
                  : (s.animate.show(e), r.onShow.call(f), r.onChange.call(f));
            },
            hide: function(e) {
              (e = T.isFunction(e) ? e : function() {}),
            ...
            animate: {
              show: function(e) {
                (e = T.isFunction(e) ? e : function() {}),
                  r.useCSS && T.fn.transition !== S && a.transition('is supported')
                    ? (r.useFlex
            ...
            has: {
              dimmer: function() {
                return r.dimmerName
                  ? 0 < u.find(n.dimmer).filter('.' + r.dimmerName).length
                  : 0 < u.find(n.dimmer).length;
              }
            },
            is: {
              active: function() {
            ...
            setting: function(e, i) {
              if ((s.debug('Changing setting', e, i), T.isPlainObject(e))) T.extend(!0, r, e);
              else {
                if (i === S) return r[e];
                T.isPlainObject(r[e]) ? T.extend(!0, r[e], i) : (r[e] = i);
              }
            },
                ...
                'string' == typeof t &&
                  ...
                  T.each(t, function(e, i) {
                    ...
                    if (T.isPlainObject(r[n]) && e != o) r = r[n];
                      ...
                      if (!T.isPlainObject(r[i]) || e == o)
                        return r[i] !== S ? (a = r[i]) : s.error(d.method, t), !1;
                      r = r[i];
                    }
                  })),
                T.isFunction(a) ? (n = a.apply(i, e)) : a !== S && (n = a),
                Array.isArray(b) ? b.push(n) : b !== S ? (b = [b, n]) : n !== S && (b = n),
                a
              );
            }
          }).preinitialize(),
    ...
    (T.fn.dimmer.settings = {
      ...
      template: {
        dimmer: function(e) {
          var i,
            n = T('<div/>').addClass('ui dimmer');
          return (
            e.displayLoader &&
              ((i = T('<div/>')
                .addClass(e.className.loader)
                .addClass(e.loaderVariation)),
              e.loaderText && (i.text(e.loaderText), i.addClass('text')),
              n.append(i)),
            n
          );
        }
