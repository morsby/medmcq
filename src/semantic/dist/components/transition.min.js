          ...
          (m = {
            initialize: function() {
              (d = m.get.settings.apply(l, b)),
                ...
                w && (w = m.invoke(y)),
                !1 === w &&
                  (m.verbose('Converted arguments into settings object', d),
                  d.interval ? m.delay(d.animate) : m.animate(),
                  m.instantiate());
            },
            ...
            animate: function(n) {
              ...
              if ((m.debug('Preparing animation', d.animation), m.is.animating())) {
                if (d.queue)
                  return (
                    !d.allowRepeats && m.has.direction() && m.is.occurring() && !0 !== m.queuing
                      ? m.debug(
                ...
                if (!d.allowRepeats && m.is.occurring())
                  return (
                    m.debug(
                ...
                m.debug('New animation started, completing previous early', d.animation),
                  s.complete();
              }
              m.can.animate()
                ? m.set.animating(d.animation)
                : m.error(e.noAnimation, d.animation, l);
            },
            reset: function() {
            ...
            force: {
              visible: function() {
                var n = f.attr('style'),
                  ...
                  a = f[0].style.display;
                return !i ||
                  ('none' === a && d.skipInlineHidden) ||
                  f[0].tagName.match(/(script|link|style)/i)
                  ? (m.remove.transition(), !1)
                  : (m.verbose('Overriding default display to show element', i),
                    f.attr('style', t),
            ...
            has: {
              ...
              inlineDisplay: function() {
                var n = f.attr('style') || '';
                return Array.isArray(n.match(/display.*?;/, ''));
              }
            },
            set: {
              ...
              duration: function(n, e) {
                ((e = 'number' == typeof (e = e || d.duration) ? e + 'ms' : e) || 0 === e) &&
                  (m.verbose('Setting animation duration', e), f.css({ 'animation-duration': e }));
              },
              direction: function(n) {
              ...
              outward: function() {
                m.debug('Setting direction to outward'),
                  f.removeClass(c.inward).addClass(c.outward);
              },
              visible: function() {
            ...
            start: {
              animation: function(n) {
                (n = n || m.get.animationClass()),
                  m.debug('Starting tween', n),
                  f.addClass(n).one(a + '.complete' + o, m.complete),
                  d.useFailSafe && m.add.failSafe(),
                  m.set.duration(d.duration),
                  d.onStart.call(l);
              }
            },
            save: {
            ...
            restore: {
              conditions: function() {
                ...
                n && (f.removeClass(n), m.verbose('Removing animation class', m.cache)),
                  m.remove.duration();
              }
            },
            add: {
            ...
            remove: {
              ...
              looping: function() {
                m.debug('Transitions are no longer looping'),
                  m.is.looping() && (m.reset(), f.removeClass(c.looping));
              },
              transition: function() {
                f.removeClass(c.transition)
            ...
            get: {
              ...
              duration: function(n) {
                return (
                  !1 === (n = n || d.duration) && (n = f.css('animation-duration') || 0),
                  'string' == typeof n
                    ? -1 < n.indexOf('ms')
                      ? parseFloat(n)
                      : 1e3 * parseFloat(n)
              ...
              displayType: function(n) {
                if (((n = n === S || n), d.displayType)) return d.displayType;
                if (n && f.data(i.displayType) === S) {
                  var e = f.css('display');
                  '' === e || 'none' === e ? m.can.transition(!0) : m.save.displayType(e);
                }
                return f.data(i.displayType);
              },
                  ...
                  if (
                    ...
                    u ||
                      ((u = t
                        ...
                        .show()
                        .css('display')),
                      m.verbose('Determining final display state', u),
                      m.save.displayType(u)),
                    t.remove(),
                    a != o)
                  )
            ...
            hide: function() {
              m.verbose('Hiding element'),
                ...
                m.remove.display(),
                m.remove.visible(),
                C.isFunction(d.onBeforeHide)
                  ? d.onBeforeHide.call(l, function() {
                      m.hideNow();
                    })
                  : m.hideNow();
            },
            hideNow: function() {
              m.set.hidden(), m.force.hidden(), d.onHide.call(l), d.onComplete.call(l);
            },
            show: function(n) {
              m.verbose('Showing element', n),
                m.force.visible() &&
                  (m.remove.hidden(), m.set.visible(), d.onShow.call(l), d.onComplete.call(l));
            },
            toggle: function() {
            ...
            debug: function() {
              !d.silent &&
                ...
                (d.performance
                  ...
                  : ((m.debug = Function.prototype.bind.call(console.info, console, d.name + ':')),
            ...
            error: function() {
              d.silent ||
                ((m.error = Function.prototype.bind.call(console.error, console, d.name + ':')),
            ...
            invoke: function(t, n, e) {
              ...
              return (
                ...
                Array.isArray(u) ? u.push(i) : u !== S ? (u = [u, i]) : i !== S && (u = i),
                o !== S && o
              );
            }
          }).initialize();
