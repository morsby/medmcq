...
// TODO: Heroku skal opdatere svar på load. Fixed med componentDidMount?
class Profile extends Component {
  ...
  generateTabContent = performance => {
    ...
    return (
      <div>
        <p>
          <strong>Du har svaret på {totalAnswers} forskellige spørgsmål</strong>
        </p>
        <div>
          <p>Af dem har du svaret</p>
          <List bulleted className="analysis">
            <List.Item>
              <span>rigtigt</span> <em>hver</em> gang på {allRight.length}{" "}
              spørgsmål
            </List.Item>
            <List.Item>
              <span>forkert</span> <em>hver</em> gang på {allWrong.length}{" "}
              spørgsmål
            </List.Item>
            <List.Item>
              <span>både</span> rigtigt <em>og</em> forkert på {mixed.length}{" "}
              spørgsmål
            </List.Item>
          </List>
        </div>
    ...
    return (
      <div className="flex-container">
        ...
        <Container className="content">
          ...
          <Divider hidden />
          <p>
            Herunder kan du se, hvordan du har klaret dig for hvert semester
          </p>
          <Tab
            panes={panes}
