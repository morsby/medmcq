...
var questions = install.questions;

var files = install.files;

var folders = install.folders;

var regExp = install.regExp;
...
module.exports = function (callback) {
  ...
  var manager = install.getPackageManager();

  var rootQuestions = questions.root;

  var installFolder = false;
...
--------------- */
  ...
  --------------- */
    ...
    gulp.task('create theme.config', function () {
      ...
      var siteVariable = "@siteFolder   : '" + pathToSite + "/';"
    ;
