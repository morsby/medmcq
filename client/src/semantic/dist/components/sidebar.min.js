                    ...
                    (c = {
                        ...
                        event: {
                            clickaway: function(e) {
                                var i =
                                        0 < v.find(e.target).length ||
                                        v.is(e.target),
                                    n = m.is(e.target);
                                i &&
                                    (c.verbose('User clicked on dimmed page'),
                                    c.hide()),
                                    n &&
                                        (c.verbose(
                        ...
                        bind: {
                            ...
                            scrollLock: function() {
                                d.scrollLock &&
                                    ...
                                    w.on('DOMMouseScroll' + a, c.event.scroll)),
                                    c.verbose(
                            ...
                            layout: function() {
                                0 === m.children(n.pusher).length &&
                                    ...
                                    m
                                        ...
                                        .wrapAll(v),
                                    c.refresh()),
                                    (0 !== h.nextAll(n.pusher).length &&
                                        h.nextAll(n.pusher)[0] === v[0]) ||
                                        (c.debug(
                                            'Moved sidebar to correct parent element'
                                        ),
                                        c.error(u.movedSidebar, p),
                        ...
                        othersAnimating: function() {
                            return (
                                0 < g.not(h).filter('.' + r.animating).length
                            );
                        },
                        ...
                        pushPage: function(i) {
                            ...
                            (i = D.isFunction(i) ? i : function() {}),
                                'scale down' == d.transition && c.scrollToTop(),
                                c.set.transition(o),
                                c.repaint(),
                                (e = function() {
                                    c.bind.clickaway(),
                        ...
                        remove: {
                            inlineCSS: function() {
                                c.debug('Removing inline css styles', s),
                        ...
                        get: {
                            ...
                            transition: function() {
                                ...
                                return (
                                    (e = c.is.mobile()
                                        ? 'auto' == d.mobileTransition
                                            ? d.defaultTransition.mobile[i]
                                            : d.mobileTransition
                                        : 'auto' == d.transition
                                        ? d.defaultTransition.computer[i]
                                        : d.transition),
