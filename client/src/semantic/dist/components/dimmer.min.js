                ...
                v.each(function() {
                    ...
                    (s = {
                        ...
                        bind: {
                            events: function() {
                                'hover' == r.on
                                    ...
                                    s.is.page() &&
                                        (s.debug('Setting as a page dimmer', i),
                                        s.set.pageDimmer()),
                                    s.is.closable() &&
                                        (s.verbose(
                        ...
                        addContent: function(e) {
                            var i = x(e);
                            s.debug('Add content to dimmer', i),
                                i.parent()[0] !== a[0] &&
                                    i.detach().appendTo(a);
                        },
                        create: function() {
                            ...
                            show: function(e) {
                                (e = x.isFunction(e) ? e : function() {}),
                                    ...
                                    a.transition('is supported')
                                        ? (r.useFlex
                                              ? (s.debug('Using flex dimmer'),
                                                s.remove.legacy())
                                              : (s.debug(
                                                    'Using legacy non-flex dimmer'
                                                ),
                                                s.set.legacy()),
                                          'auto' !== r.opacity &&
                                              s.set.opacity(),
                                          a.transition({
                                              displayType: r.useFlex
                                                  ? 'flex'
                                                  : 'block',
                        ...
                        is: {
                            ...
                            animating: function() {
                                return (
                                    a.is(':animated') || a.hasClass(t.animating)
                                );
                            },
                            closable: function() {
                                return 'auto' == r.closable
                                    ? 'hover' != r.on
                                    : r.closable;
                            },
                            dimmer: function() {
