                    ...
                    (m = {
                        ...
                        destroy: function() {
                            m.verbose('Destroying previous instance'),
                                ...
                                t && t.disconnect(),
                                f
                                    .off('load' + c, m.event.load)
                                    .off('resize' + c, m.event.resize),
                        ...
                        checkErrors: function() {
                            if (
                                ...
                                return (
                                    m.reset(), void m.error(r.elementSize, a)
                                );
                        },
                        bind: {
                            events: function() {
                                f
                                    .on('load' + c, m.event.load)
                                    .on('resize' + c, m.event.resize),
                                    d
                                        .off('scroll' + c)
                                        .on('scroll' + c, m.event.scroll)
                                        .on(
                                            'scrollchange' + c,
                                            m.event.scrollchange
                                        );
                            },
                        },
                        event: {
                        ...
                        get: {
                            ...
                            currentElementScroll: function() {
                                return m.elementScroll
                                    ...
                                    : Math.abs(parseInt(a.css('bottom'), 10)) ||
                                      0;
                            },
                            elementScroll: function(e) {
                                e = e || d.scrollTop();
                        ...
                        set: {
                            ...
                            scroll: function(e) {
                                m.debug('Setting scroll on element', e),
                                    m.elementScroll != e &&
                                        (m.is.top() &&
                                            a.css('bottom', '').css('top', -e),
                                        m.is.bottom() &&
                                            a.css('top', '').css('bottom', e));
                            },
                            size: function() {
                        ...
                        k
                            ? (h === P && m.initialize(), m.invoke(y))
                            : (h !== P && h.invoke('destroy'), m.initialize());
                }),
                v !== P ? v : this
            );
        }),
