        ...
        E.each(function() {
          ...
          (h = {
            initialize: function() {
              h.get.settings(),
                F
                  ? (g === O && h.instantiate(), h.invoke(V))
                  : (g !== O && g.invoke('destroy'),
                    h.verbose('Initializing form validation', o, d),
                    h.bindEvents(),
                    h.set.defaults(),
                    h.instantiate());
            },
            ...
            bindEvents: function() {
              h.verbose('Attaching form events'),
                ...
                d.keyboardShortcuts && o.on('keydown' + s, f.field, h.event.field.keydown),
                n.each(function() {
                  var e = T(this),
                    t = e.prop('type'),
                    n = h.get.changeEvent(t, e);
                  T(this).on(n + s, h.event.field.change);
                });
            },
            clear: function() {
              n.each(function() {
                var e = T(this),
                  ...
                  n = e.closest(u),
                  r = n.find(f.prompt),
                  i = e.data(l.defaultValue) || '',
                  a = t.is(f.uiCheckbox),
                  o = t.is(f.uiDropdown);
                n.hasClass(p.error) &&
                  (h.verbose('Resetting error on field', n), n.removeClass(p.error), r.remove()),
                  o
                    ? (h.verbose('Resetting dropdown value', t, i), t.dropdown('clear'))
                    : a
                    ? e.prop('checked', !1)
                    : (h.verbose('Resetting field value', e, i), e.val(''));
              });
            },
            reset: function() {
              n.each(function() {
                ...
                i !== O &&
                  (s &&
                    (h.verbose('Resetting error on field', n), n.removeClass(p.error), r.remove()),
                  o
                    ? (h.verbose('Resetting dropdown value', t, i), t.dropdown('restore defaults'))
                    : a
                    ? (h.verbose('Resetting checkbox value', t, i), e.prop('checked', i))
                    : (h.verbose('Resetting field value', e, i), e.val(i)));
              });
            },
            determine: {
              isValid: function() {
            ...
            removeEvents: function() {
              o.off(s), n.off(s), e.off(s), n.off(s);
            },
            event: {
              field: {
                keydown: function(e) {
                ...
                blur: function(e) {
                  var t = T(this),
                    n = t.closest(u),
                    r = h.get.validation(t);
                  n.hasClass(p.error)
                    ? (h.debug('Revalidating field', t, r), r && h.validate.field(r))
                    : 'blur' == d.on && r && h.validate.field(r);
                },
                change: function(e) {
                  var t = T(this),
                    n = t.closest(u),
            ...
            get: {
              ...
              prompt: function(e, t) {
                var n,
                  ...
                  s = o.val(),
                  l = T.isFunction(e.prompt)
                    ? e.prompt(s)
                    : e.prompt || d.prompt[i] || d.text.unspecifiedRule,
                  u = -1 !== l.search('{value}'),
                  c = -1 !== l.search('{name}');
                return (
                  u && (l = l.replace('{value}', o.val())),
                  c &&
                    ((r =
                      1 ==
                      (n = o
                  ...
                  e.prompt || h.verbose('Using default validation prompt for type', l, i),
                  l
                );
              },
              settings: function() {
                if (T.isPlainObject(x)) {
                  ...
                  0 < e.length && (x[e[0]].identifier !== O && x[e[0]].rules !== O)
                    ? ((d = T.extend(!0, {}, T.fn.form.settings, R)),
                      (c = T.extend({}, T.fn.form.settings.defaults, x)),
                    ...
                    : (x.fields &&
                      ...
                      (c = T.extend({}, T.fn.form.settings.defaults, d.fields)),
                      h.verbose('Extending settings', c, d));
                } else
                  (d = T.fn.form.settings),
                    (c = T.fn.form.settings.defaults),
              ...
              validation: function(r) {
                ...
                return (
                  ...
                  (T.each(c, function(e, n) {
                    (a = n.identifier || e),
                      T.each(h.get.field(a), function(e, t) {
                        if (t == r[0]) return (n.identifier = a), (i = n), !1;
                      });
                  }),
                  i || !1)
                );
                  ...
                  t.each(function(e, t) {
                    ...
                    r &&
                      (s
                        ? ((r = r.replace('[]', '')),
                          u[r] || (u[r] = []),
                          a ? (l ? u[r].push(i || !0) : u[r].push(!1)) : u[r].push(i))
                        : o
                        ? (u[r] !== O && 0 != u[r]) || (u[r] = !!l && (i || !0))
                        : (u[r] = a ? !!l && (i || !0) : i));
                  }),
                  u
                );
            ...
            has: {
              field: function(e) {
                return (
                  ...
                  'string' != typeof (e = h.escape.string(e)) && h.error(m.identifier, e),
                  0 < n.filter('#' + e).length ||
            ...
            add: {
              ...
              prompt: function(e, t, n) {
                var r = h.get.field(e).closest(u),
                  i = r.children(f.prompt),
                  a = 0 !== i.length;
                (t = 'string' == typeof t ? [t] : t),
                  h.verbose('Adding field error state', e),
                  n || r.addClass(p.error),
                  d.inline &&
                    (a || (i = d.templates.prompt(t)).appendTo(r),
                    i.html(t[0]),
                    a
            ...
            remove: {
              rule: function(n, e) {
                ...
                if (e == O) return h.debug('Removed all rules'), void (c[n].rules = []);
                c[n] != O &&
                  Array.isArray(c[n].rules) &&
                  T.each(c[n].rules, function(e, t) {
                    -1 !== r.indexOf(t.type) &&
              ...
              values: function(e) {
                T.isEmptyObject(e) ||
                  T.each(e, function(e, t) {
                    ...
                    0 < r.length &&
                      (a && o
                        ? (h.verbose('Selecting multiple', t, r),
                          i.checkbox('uncheck'),
                          T.each(t, function(e, t) {
                            (n = r.filter('[value="' + t + '"]')),
                              (i = n.parent()),
                        ...
                        : l
                        ? (h.verbose('Selecting radio value', t, r),
                          r
                            .filter('[value="' + t + '"]')
                            .parent(f.uiCheckbox)
                            .checkbox('check'))
                        : o
                        ? (h.verbose('Setting checkbox value', t, i),
                          !0 === t ? i.checkbox('check') : i.checkbox('uncheck'))
                        : s
                        ? (h.verbose('Setting dropdown value', t, i), i.dropdown('set selected', t))
                        : (h.verbose('Setting field value', t, r), r.val(t)));
                  });
              }
            },
            validate: {
              ...
              field: function(r, e, i) {
                (i = i === O || i),
                  'string' == typeof r && (h.verbose('Validating field', r), (r = c[(e = r)]));
                var a = r.identifier || e,
                  t = h.get.field(a),
                  n = !!r.depends && h.get.field(r.depends),
                  o = !0,
                  s = [];
                r.identifier || (h.debug('Using field name as identifier', a), (r.identifier = a));
                var l = !0;
                return (
                  T.each(t, function() {
                    if (!T(this).prop('disabled')) return (l = !1);
                  }),
                  l
                    ? h.debug('Field is disabled. Skipping', a)
                    : r.optional && h.is.blank(t)
                    ? h.debug('Field is optional and blank. Skipping', a)
                    : r.depends && h.is.empty(n)
                    ? h.debug(
                        'Field depends on another value that is not present or empty. Skipping',
                        n
                      )
                    : r.rules !== O &&
                      (t.closest(u).removeClass(p.error),
                      T.each(r.rules, function(e, t) {
                        if (h.has.field(a)) {
                          var n = h.validate.rule(r, t, !0) || [];
                          0 < n.length &&
                            (h.debug('Field is invalid', a, t.type),
                            s.push(h.get.prompt(t, r)),
                            (o = !1),
                            i &&
                              T(n)
                                .closest(u)
                  ...
                  o
                    ? (i && (h.remove.prompt(a, s), d.onValid.call(t)), !0)
                    : (i && ((b = b.concat(s)), h.add.prompt(a, s, !0), d.onInvalid.call(t, s)), !1)
                );
              },
              rule: function(e, t, n) {
                var r = h.get.field(e.identifier),
                  i = (t.type, h.get.ancillaryValue(t)),
                  a = h.get.ruleName(t),
                  o = d.rules[a],
                  s = [],
                  l = r.is(f.radio),
            ...
            invoke: function(r, e, t) {
              ...
              return (
                ...
                Array.isArray(k) ? k.push(n) : k !== O ? (k = [k, n]) : n !== O && (k = n),
                a
              );
            }
          }).initialize();
        ...
        creditCard: function(n, e) {
          ...
          if ('string' == typeof n && 0 !== n.length) {
            ...
            for (
              ...
              (d += c[u][parseInt(n.charAt(l), 10)]), (u ^= 1);
            return d % 10 == 0 && 0 < d;
          }
        },
