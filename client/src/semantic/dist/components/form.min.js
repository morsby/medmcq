            ...
            return (
                E.each(function() {
                    ...
                    (h = {
                        ...
                        destroy: function() {
                            h.verbose('Destroying previous module', g),
                                h.removeEvents(),
                                o.removeData(a);
                        },
                        refresh: function() {
                        ...
                        bindEvents: function() {
                            h.verbose('Attaching form events'),
                                o
                                    .on('submit' + m, h.validate.form)
                                    .on('blur' + m, f.field, h.event.field.blur)
                                    .on('click' + m, f.submit, h.submit)
                                    .on('click' + m, f.reset, h.reset)
                                    .on('click' + m, f.clear, h.clear),
                                d.keyboardShortcuts &&
                                    o.on(
                                        'keydown' + m,
                                        f.field,
                                        h.event.field.keydown
                                    ),
                                n.each(function() {
                                    var e = T(this),
                                        t = e.prop('type'),
                        ...
                        event: {
                            field: {
                                ...
                                blur: function(e) {
                                    ...
                                    n.hasClass(p.error)
                                        ? (h.debug('Revalidating field', t, r),
                                          r && h.validate.field(r))
                                        : 'blur' == d.on &&
                                          r &&
                                          h.validate.field(r);
                                },
                        ...
                        get: {
                            ...
                            ruleName: function(e) {
                                return h.is.bracketedRule(e)
                                    ? e.type.replace(
                                          e.type.match(d.regExp.bracket)[0],
                                          ''
                                      )
                                    : e.type;
                            },
                                ...
                                if (T.isPlainObject(x)) {
                                    ...
                                    (x[e[0]].identifier !== O &&
                                        ...
                                        : (x.fields &&
                                              ...
                                              (x.fields = h.get.fieldsFromShorthand(
                                                  x.fields
                                              )),
                                          (d = T.extend(
                                              !0,
                        ...
                        has: {
                            field: function(e) {
                                return (
                                    ...
                                    'string' !=
                                        typeof (e = h.escape.string(e)) &&
                                        h.error(l.identifier, e),
                                    0 < n.filter('#' + e).length ||
                                        (0 <
                                            n.filter('[name="' + e + '"]')
                                                .length ||
        ...
        (T.fn.form.settings = {
            ...
            rules: {
                ...
                contains: function(e, t) {
                    return (
                        (t = t.replace(
                            T.fn.form.settings.regExp.escape,
                            '\\$&'
                        )),
                    ...
                    if ('string' == typeof n && 0 !== n.length) {
                        ...
                        if (
                            (t = {
                                number:
                                    -1 !==
                                    T.inArray(n.length, i.unionPay.length),
