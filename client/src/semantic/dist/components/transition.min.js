            ...
            return (
                r.each(function(t) {
                    ...
                    (m = {
                        ...
                        animate: function(n) {
                            if (((d = n || d), !m.is.supported()))
                                return m.error(e.support), !1;
                            if (
                                (m.debug('Preparing animation', d.animation),
                                m.is.animating())
                            ) {
                                if (d.queue)
                                    return (
                        ...
                        set: {
                            ...
                            duration: function(n, e) {
                                ((e =
                                    ...
                                    f.css({ 'animation-duration': e }));
                            },
                            direction: function(n) {
                                (n = n || m.get.direction()) == c.inward
                                    ? m.set.inward()
                                    : m.set.outward();
                            },
                            looping: function() {
                                m.debug('Transition set to loop'),
                                    f.addClass(c.looping);
                            },
                            hidden: function() {
                            ...
                            inward: function() {
                                m.debug('Setting direction to inward'),
                                    f.removeClass(c.outward).addClass(c.inward);
                            },
                            outward: function() {
                        ...
                        remove: {
                            ...
                            looping: function() {
                                m.debug('Transitions are no longer looping'),
                                    m.is.looping() &&
                                        (m.reset(), f.removeClass(c.looping));
                            },
                            transition: function() {
                            ...
                            displayType: function(n) {
                                return (
                                    ...
                                    d.displayType
                                        ? d.displayType
                                        : (n &&
                                              f.data(i.displayType) === S &&
                                              m.can.transition(!0),
                                          f.data(i.displayType))
                                );
                            },
                            userStyle: function(n) {
                                return (n = n || f.attr('style') || '').replace(
                                    /display.*?;/,
                                    ''
                                );
                            },
                            ...
                            transition: function(n) {
                                ...
                                if (l === S || n) {
                                    if (
                                        ...
                                        m.debug('Static animation found', s, u),
                                            (r = !1);
                                    }
                        ...
                        enable: function() {
                            m.verbose('Starting animation'),
                                f.removeClass(c.disabled);
                        },
                        disable: function() {
                            m.debug('Stopping animation'),
                                f.addClass(c.disabled);
                        },
                        setting: function(n, e) {
                            if (
                                (m.debug('Changing setting', n, e),
                                C.isPlainObject(n))
                            )
                                C.extend(!0, d, n);
                            else {
