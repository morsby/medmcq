        ...
        (j.fn.modal = function(w) {
            ...
            return (
                e.each(function() {
                    ...
                    (c = {
                        initialize: function() {
                            c.verbose('Initializing dimmer', b),
                                c.create.id(),
                                c.create.dimmer(),
                                c.refreshModals(),
                                c.bind.events(),
                        ...
                        attachEvents: function(e, n) {
                            var i = j(e);
                            (n = j.isFunction(c[n]) ? c[n] : c.toggle),
                                0 < i.length
                                    ? (c.debug(
                        ...
                        bind: {
                            events: function() {
                                c.verbose('Attaching events'),
                                    v
                                        .on('click' + g, d.close, c.event.close)
                                        .on(
                                            'click' + g,
                                            d.approve,
                                            c.event.approve
                                        )
                                        .on('click' + g, d.deny, c.event.deny),
                                    F.on('resize' + n, c.event.resize);
                            },
                            scrollLock: function() {
                        ...
                        event: {
                            ...
                            click: function(e) {
                                if (l.closable) {
                                    var n =
                                            0 <
                                            j(e.target).closest(d.modal).length,
                                        i = j.contains(
                                            L.documentElement,
                                            e.target
                                        );
                        ...
                        add: {
                            keyboardShortcuts: function() {
                                c.verbose('Adding keyboard shortcuts'),
                                    M.on('keyup' + g, c.event.keyboard);
                            },
                        },
                        save: {
                            focus: function() {
                                0 < j(L.activeElement).closest(v).length ||
                        ...
                        remove: {
                            ...
                            scrolling: function() {
                                o.removeClass(u.scrolling),
                                    v.removeClass(u.scrolling);
                            },
                        },
                        cacheSizes: function() {
                        ...
                        is: {
                            ...
                            animating: function() {
                                return v.transition('is supported')
                                    ? v.transition('is animating')
                                    : v.is(':visible');
                            },
                            scrolling: function() {
                        ...
                        set: {
                            ...
                            modalOffset: function() {
                                ...
                                v.css({
                                    marginTop:
                                        l.centered && c.can.fit() ? -n / 2 : 0,
                                    marginLeft: -e / 2,
                                }),
                                    c.verbose(
                                        'Setting modal offset for legacy mode'
                                    );
                            },
                            screenHeight: function() {
                                c.can.fit()
                        ...
                        T
                            ? (k === N && c.initialize(), c.invoke(D))
                            : (k !== N && k.invoke('destroy'), c.initialize());
                }),
                C !== N ? C : this
            );
        }),
