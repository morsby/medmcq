                ...
                q(this).each(function() {
                    ...
                    (f = {
                            ...
                            events: function() {
                                f.verbose('Binding events to search'),
                                    ...
                                    m
                                        ...
                                        .on('blur' + n, h.prompt, f.event.blur)
                                        .on(
                                            'keydown' + n,
                                            h.prompt,
                                            f.handleKeyboard
                        ...
                        get: {
                            settings: function() {
                                q.isPlainObject(o) &&
                                    ...
                                    f.error(u.error.oldSearchSyntax, y));
                            },
                            inputEvent: function() {
                                var e = v[0];
                        ...
                        set: {
                            ...
                            type: function(e) {
                                (e = e || u.type),
                                    'category' == u.type && m.addClass(u.type);
                            },
                                ...
                                f.has.minimumCharacters()
                                    ? (s
                                          ...
                                          : (f.debug('Querying for', t),
                                            q.isPlainObject(u.source) ||
                                            q.isArray(u.source)
                                                ? (f.search.local(t), e())
                                                : f.can.useAPI()
                                                ? f.search.remote(t, e)
                                                : (f.error(p.source), e())),
                                      u.onSearchQuery.call(y, t))
                                    : f.hideResults();
                        },
                        search: {
                            local: function(e) {
                                var t,
                                    s = f.search.object(e, u.content);
                                f.set.loading(),
                                    f.save.results(s),
                                    f.debug(
                        ...
                        create: {
                            ...
                            id: function(e, t) {
                                ...
                                return (
                                    t !== D
                                        ? ((s =
                                              String.fromCharCode(97 + t) + n),
                                          f.verbose(
                                              'Creating category result id',
                                              s
                                          ))
                                        : ((s = n),
                                          f.verbose('Creating result id', s)),
                                    s
                                );
                            },
                            results: function() {
                        ...
                        generateResults: function(e) {
                            ...
                            var t = u.templates[u.type],
                                ...
                                n =
                                    q.isArray(e[i.results]) &&
                                    0 < e[i.results].length,
                                r = '';
                            return (
                                s || n
                                    ? (0 < u.maxResults &&
                                          (s
                                              ? 'standard' == u.type &&
                                                f.error(p.maxResults)
                                              : (e[i.results] = e[
                                                    i.results
                                                ].slice(0, u.maxResults))),
                                      q.isFunction(t)
                                          ? (r = t(e, i))
                        ...
                        displayMessage: function(e, t) {
                            return (
                                ...
                                f.addResults(u.templates.message(e, t)),
                        ...
                        T
                            ? (c === D && f.initialize(), f.invoke(j))
                            : (c !== D && c.invoke('destroy'), f.initialize());
                }),
                C !== D ? C : this
            );
        }),
