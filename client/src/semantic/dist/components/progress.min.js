    ...
    (E.fn.progress = function(m) {
      ...
      return (
        e.each(function() {
          ...
          (s = {
            initialize: function() {
              s.debug('Initializing progress bar', r),
                s.set.duration(),
            ...
            instantiate: function() {
              s.verbose('Storing instance of progress', s), (v = s), c.data(i, s);
            },
            destroy: function() {
            ...
            read: {
              ...
              settings: function() {
                !1 !== r.total &&
                  (s.debug('Current total set in settings', r.total), s.set.total(r.total)),
                  !1 !== r.value &&
                    (s.debug('Current value set in settings', r.value),
                    s.set.value(r.value),
                    s.set.progress(s.value)),
                  !1 !== r.percent &&
                    (s.debug('Current percent set in settings', r.percent),
                    s.set.percent(r.percent));
              }
            },
            bind: {
            ...
            set: {
              ...
              percent: function(e) {
                (e = 'string' == typeof e ? +e.replace('%', '') : e),
                  ...
                  s.has.total() ||
                    ((s.value =
                      0 < r.precision
                        ? Math.round((e / 100) * s.total * (10 * r.precision)) / (10 * r.precision)
                        : Math.round((e / 100) * s.total * 10) / 10),
                    r.limitValues && (s.value = 100 < s.value ? 100 : s.value < 0 ? 0 : s.value)),
                  s.set.barWidth(e),
                  s.set.labelInterval(),
                  s.set.labels(),
                  r.onChange.call(p, e, s.value, s.total);
              },
              labelInterval: function() {
                clearInterval(s.interval),
                  ...
                  (s.interval = setInterval(function() {
                    E.contains(P.documentElement, p) || (clearInterval(s.interval), (f = !1)),
                      s.set.labels();
                  }, r.framerate));
              },
              labels: function() {
              ...
              label: function(e) {
                (e = e || '') &&
                  ((e = s.get.text(e)), s.verbose('Setting label to text', e), d.text(e));
              },
              state: function(e) {
                100 === (e = e !== T ? e : s.percent)
                  ? r.autoSuccess && !(s.is.warning() || s.is.error() || s.is.success())
                  ...
                  : (s.remove.active(), s.set.label(r.text.active));
              },
              barLabel: function(e) {
                e !== T
                  ? g.text(s.get.text(e))
                  : 'ratio' == r.label && s.total
                  ? (s.verbose('Adding ratio to bar label'), g.text(s.get.text(r.text.ratio)))
                  : 'percent' == r.label &&
                    (s.verbose('Adding percentage to bar label'),
                    g.text(s.get.text(r.text.percent)));
              },
              active: function(e) {
                (e = e || r.text.active),
                  s.debug('Setting active state'),
                  r.showActivity && !s.is.active() && c.addClass(t.active),
                  s.remove.warning(),
                  s.remove.error(),
                  s.remove.success(),
                  (e = r.onLabelUpdate('active', e, s.value, s.total)) && s.set.label(e),
                  s.bind.transitionEnd(function() {
                    r.onActive.call(p, s.value, s.total);
                  });
              },
              success: function(e) {
                (e = e || r.text.success || r.text.active),
                  ...
                  s.complete(),
                  (e = r.text.success
                    ? r.onLabelUpdate('success', e, s.value, s.total)
                    : r.onLabelUpdate('active', e, s.value, s.total)),
                  s.set.label(e),
                  s.bind.transitionEnd(function() {
                    r.onSuccess.call(p, s.total);
                  });
              },
              warning: function(e) {
                (e = e || r.text.warning),
                  ...
                  s.remove.error(),
                  s.complete(),
                  (e = r.onLabelUpdate('warning', e, s.value, s.total)) && s.set.label(e),
                  s.bind.transitionEnd(function() {
                    r.onWarning.call(p, s.value, s.total);
                  });
              },
              error: function(e) {
                (e = e || r.text.error),
                  ...
                  s.remove.warning(),
                  s.complete(),
                  (e = r.onLabelUpdate('error', e, s.value, s.total)) && s.set.label(e),
                  s.bind.transitionEnd(function() {
                    r.onError.call(p, s.value, s.total);
                  });
              },
                  ...
                  E.each(r, function(e, t) {
                    ...
                    if (E.isPlainObject(i[n]) && e != a) i = i[n];
                      ...
                      if (!E.isPlainObject(i[t]) || e == a)
                        return i[t] !== T ? (o = i[t]) : s.error(l.method, r), !1;
                      i = i[t];
                    }
                  })),
                E.isFunction(o) ? (n = o.apply(t, e)) : o !== T && (n = o),
                Array.isArray(b) ? b.push(n) : b !== T ? (b = [b, n]) : n !== T && (b = n),
                o
              );
            }
          }),
            V
              ? (v === T && s.initialize(), s.invoke(w))
              : (v !== T && v.invoke('destroy'), s.initialize());
        }),
        b !== T ? b : this
      );
    }),
