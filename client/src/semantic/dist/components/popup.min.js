                    ...
                    (c = {
                        ...
                        refresh: function() {
                            d.popup
                                ? (u = N(d.popup).eq(0))
                                : d.inline &&
                                  ((u = b.nextAll(i.popup).eq(0)),
                                  (d.popup = u)),
                                d.popup
                                    ? (u.addClass(f.loading),
                                      (p = c.get.offsetParent()),
                                      u.removeClass(f.loading),
                                      d.movePopup &&
                                          c.has.popup() &&
                                          c.get.offsetParent(u)[0] !== p[0] &&
                                          (c.debug(
                                ...
                                p.is('html') &&
                                    p[0] !== A[0] &&
                                    (c.debug('Setting page as offset parent'),
                                    (p = A)),
                        ...
                        event: {
                            start: function(t) {
                                var e = N.isPlainObject(d.delay)
                                    ? d.delay.show
                                    : d.delay;
                                clearTimeout(c.hideTimer),
                                    P || (c.showTimer = setTimeout(c.show, e));
                            },
                            end: function() {
                                var t = N.isPlainObject(d.delay)
                                    ? d.delay.hide
                                    : d.delay;
                                clearTimeout(c.showTimer),
                        ...
                        get: {
                            html: function() {
                                return (
                                    m.removeData(h.html),
                                    m.data(h.html) || d.html
                                );
                            },
                            title: function() {
                                return (
                                    m.removeData(h.title),
                                    m.data(h.title) || d.title
                                );
                            },
                            content: function() {
                                return (
                                    m.removeData(h.content),
                                    m.data(h.content) ||
                                        d.content ||
                                        m.attr('title')
                                );
                            ...
                            variation: function() {
                                return (
                                    m.removeData(h.variation),
                                    m.data(h.variation) || d.variation
                                );
                            },
                            popup: function() {
                                return u;
                        ...
                        set: {
                                ...
                                if (0 !== b.length && 0 !== u.length) {
                                    ...
                                    if (
                                        ...
                                        u
                                            ...
                                            .addClass(f.loading),
                                        (l = c.get.popupOffset()),
                                        (p = c.get.distanceFromBoundary(l, e)),
                                        c.is.offstage(p, t))
                                    ) {
                                        if (
                                            (c.debug(
                            ...
                            variation: function(t) {
                                (t = t || c.get.variation()) &&
                                    c.has.popup() &&
                                    (c.verbose('Adding variation to popup', t),
                                    u.addClass(t));
                            },
                            visible: function() {
                        ...
                        remove: {
                            ...
                            variation: function(t) {
                                (t = t || c.get.variation()) &&
                                    (c.verbose('Removing variation', t),
                                    u.removeClass(t));
                            },
                            visible: function() {
                        ...
                        bind: {
                            events: function() {
                                c.debug('Binding popup events to module'),
                                    ...
                                    d.target &&
                                        c.debug('Target set to element', b),
                            ...
                            popup: function() {
                                c.verbose(
                                    ...
                                    u &&
                                        c.has.popup() &&
                                        u
                                            .on('mouseenter' + r, c.event.start)
                                            .on('mouseleave' + r, c.event.end);
                            },
                            close: function() {
                                (!0 === d.hideOnScroll ||
                                    ('auto' == d.hideOnScroll &&
                        ...
                        should: {
                            centerArrow: function(t) {
                                return (
                                    !c.is.basic() &&
                                    t.target.width <= 2 * d.arrowPixelsFromEdge
                                );
                            },
                        },
                        is: {
                            closable: function() {
                                return 'auto' == d.closable
                                    ? 'hover' != d.on
                                    : d.closable;
                            },
