            ...
            return (
                d.each(function() {
                    ...
                    (v = {
                        ...
                        destroy: function() {
                            v.debug('Destroying tabs', P),
                                P.removeData(a).off(e);
                        },
                        bind: {
                            events: function() {
                                E.isWindow(s) ||
                            ...
                            callbacks: function() {
                                E.isPlainObject(r) &&
                                    ...
                                    (r.onTabLoad &&
                                        ...
                                        delete r.onTabLoad,
                                        v.error(A.legacyLoad, r.onLoad)),
                                    r.onTabInit &&
                                        ((r.onFirstLoad = r.onTabInit),
                                        delete r.onTabInit,
                                        v.error(A.legacyInit, r.onFirstLoad)),
                                    (T = E.extend(
                                        !0,
                                        {},
                                        E.fn.tab.settings,
                        ...
                        initializeHistory: function() {
                            if (
                                (v.debug('Initializing page state'),
                                E.address === k)
                            )
                                return v.error(A.state), !1;
                            if ('state' == T.historyType) {
                                if (
                                    (v.debug('Using HTML5 to manage state'),
                                    !1 === T.path)
                                )
                                    return v.error(A.path), !1;
                        ...
                        changeTab: function(u) {
                            var b =
                                ...
                                f =
                                    g && !b
                                        ? v.utilities.pathToArray(u)
                                        : v.get.defaultPathArray(u);
                        ...
                        is: {
                            tab: function(e) {
                                return (
                                    e !== k && 0 < v.get.tabElement(e).length
                                );
                            },
                        },
                        get: {
                            initialPath: function() {
                                return (
                                    d.eq(0).data(x.tab) || o.eq(0).data(x.tab)
                                );
                            },
                            path: function() {
                            ...
                            defaultPathArray: function(e) {
                                return v.utilities.pathToArray(
                                    v.get.defaultPath(e)
                                );
                            },
                            defaultPath: function(e) {
                                ...
                                if (t) {
                                    if (
                                        (v.debug('Found default tab', t),
                                        i < T.maxDepth)
                                    )
                                        return i++, v.get.defaultPath(t);
                                    v.error(A.recursion);
                                } else
                                    v.debug('No default tabs found for', e, o);
                                return (i = 0), e;
                            },
                            navElement: function(e) {
                                return (
                                    (e = e || p),
                                    d.filter('[data-' + x.tab + '="' + e + '"]')
                                );
                            },
