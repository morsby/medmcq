    ...
    (b.site = b.fn.site = function(e) {
        ...
        return (
            (a = {
                ...
                console: function(e) {
                    if (e) {
                        if (f.cache.console === h)
                            return void a.error(m.console);
                        a.debug('Restoring console function'),
                            (p.console = f.cache.console);
                    } else
                        a.debug('Disabling console function'),
                            (f.cache.console = p.console),
                            (p.console = {
                                clear: function() {},
                                error: function() {},
                                group: function() {},
                ...
                destroy: function() {
                    a.verbose('Destroying previous site for', d),
                        d.removeData(r);
                },
                cache: {},
            ...
            o
                ? (f === h && a.initialize(), a.invoke(n))
                : (f !== h && a.destroy(), a.initialize()),
            c !== h ? c : this
        );
    }),
        (b.site.settings = {
