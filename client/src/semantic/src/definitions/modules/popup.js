            ...
            module = {
                    ...
                    documentChanged: function(mutations) {
                        [].forEach.call(mutations, function(mutation) {
                            if (mutation.removedNodes) {
                                [].forEach.call(mutation.removedNodes, function(
                                    node
                                ) {
                                    if (
                                        node == element ||
                ...
                set: {
                    position: function(position, calculations) {
                        ...
                        if (module.is.rtl()) {
                            position = position.replace(/left|right/g, function(
                                match
                            ) {
                ...
                bind: {
                    ...
                    touchClose: function() {
                        ...
                        $document.on('touchstart' + elementNamespace, function(
                            event
                        ) {
                    ...
                    clickaway: function() {
                        ...
                        $document.on('click' + elementNamespace, function(
                            event
                        ) {
                ...
                is: {
                    ...
                    offstage: function(distanceFromBoundary, position) {
                        ...
                        $.each(distanceFromBoundary, function(
                            direction,
                            distance
                        ) {
