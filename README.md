...
- [ ] Optimering af visning af besvarede spørgsmål (loading er langsom). Evt. via [react-window](https://github.com/bvaughn/react-window)? [CSS overflow-x](https://www.w3schools.com/cssref/css3_pr_overflow-x.asp) sat til auto bør også virke, uden ekstra dependancies.
